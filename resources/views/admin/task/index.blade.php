        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">{{__('master.tasks')}}</h1>
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <li class="breadcrumb-item text-muted">{{__('master.task')}}</li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-title">
                            ...
                            <form action="{{URL::current()}}" method="GET">
                                <div class="d-flex align-items-center position-relative my-1">
                                    ...
                                    <input type="text" name="keyword" value="{{ old('keyword', request()->input('keyword')) }}"  data-kt-customer-table-filter="search" class="form-control form-control-solid w-250px ps-12" placeholder="{{__('master.search task')}}" />
                                </div>
                            </form>
                        </div>
                        <!--begin::Card title-->
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                        ...
                                        <div class="px-7 py-5">
                                            ...
                                            <div class="mb-10">
                                                ...
                                                <select name="status" class="form-select form-select-solid fw-bold" data-kt-select2="true" data-placeholder="{{__('master.select status')}}" data-allow-clear="true" data-kt-customer-table-filter="month" data-dropdown-parent="#kt-toolbar-filter">
                                                    ...
                                                    <option value="In Progress" {{ old('status', request()->input('status')) == 'In Progress' ? 'selected' : '' }}>{{__('master.in progress')}}</option>
                                                    <option value="Completed" {{ old('status', request()->input('status')) == 'Completed' ? 'selected' : '' }}>{{__('master.complete')}}</option>
                                                </select>
                                                <!--end::Input-->
                                            </div>
                                            <!--end::Input group-->
                                ...
                                <!--end::Export-->
                                <!--begin::Add customer-->
                                <a  class="btn btn-primary"  href="{{route('admin.tasks.create')}}">{{__('master.add task')}}</a>
                                <!--end::Add customer-->
                            </div>
                            <!--end::Toolbar-->
                            <!--begin::Group actions-->
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" >
                            <thead>
                                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-125px">{{__('master.description')}}</th>
                                    <th class="min-w-125px">{{__('master.status')}}</th>
                                    <th class="min-w-125px">{{__('master.admin')}}</th>
                                        ...
                                        <td class="text-end">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                                <div class="menu-item px-3">
                                                    <a href="{{route('admin.tasks.edit',$task->id)}}" class="menu-link px-3"> {{__('master.edit')}} </a>
                                                </div>
                                                <div class="menu-item px-3">
                                                    <a href="{{route('admin.tasks.delete',$task->id)}}" class="menu-link px-3"> {{__('master.delete')}} </a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
