            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">{{__('master.add task')}}</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                        ...
                        <form class="form" action="{{route('admin.tasks.store')}}" method="POST" enctype="multipart/form-data" id="kt_subscriptions_create_new">
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <div class="d-flex flex-column mb-15 fv-row">
                                        ...
                                        <div class="d-flex flex-column mb-10 fv-row">
                                            ...
                                            <!--end::Label-->
                                            <input class="form-control form-control-solid rounded-3" placeholder="{{__('master.enter task name')}}" name="name" value="{{old('name')}}"/>
                                        </div>
                                        <!--end::Label-->
                                        <div class="d-flex flex-column mb-10 fv-row">
                                            <!--begin::Label-->
                                            ...
                                            <!--end::Label-->
                                            <textarea class="form-control form-control-solid rounded-3" placeholder="{{__('master.enter task description')}}" rows="4" name="description">{{old('description')}}</textarea>
                                        </div>
                                        <div class="d-flex flex-column mb-10 fv-row">
                            ...
                            <div class="mb-0">
                                <button type="submit" class="btn btn-primary" id="kt_subscriptions_create_button">
                                    ...
                                    <span class="indicator-label">{{__('master.create task')}}</span>
                                    <!--end::Indicator label-->
