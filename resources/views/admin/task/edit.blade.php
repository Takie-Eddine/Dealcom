            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--end::Item-->
                        <li class="breadcrumb-item text-muted">
                            <a href="{{route('admin.tasks')}}" class="text-muted text-hover-primary">{{__('master.task')}}</a>
                        </li>
                        <li class="breadcrumb-item">
                            <span class="bullet bg-gray-400 w-5px h-2px"></span>
                        </li>
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">{{__('master.edit task')}}</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                        ...
                        <form class="form" action="{{route('admin.tasks.update',$task->id)}}" method="POST" enctype="multipart/form-data" id="kt_subscriptions_create_new">
                            ...
                            <div class="card card-flush pt-3 mb-5 mb-lg-10">
                                ...
                                <div class="card-header">
                                    ...
                                    <div class="card-title">
                                        <h2 class="fw-bold">{{__('master.tasks')}}</h2>
                                    </div>
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <div class="d-flex flex-column mb-15 fv-row">
                                        ...
                                        <div class="d-flex flex-column mb-10 fv-row">
                                            <!--begin::Label-->
                                            <div class="fs-5 fw-bold required form-label mb-3">{{__('master.name')}}</div>
                                            <!--end::Label-->
                                            <input class="form-control form-control-solid rounded-3" placeholder="{{__('master.enter task name')}}" name="name" value="{{$task->name}}"/>
                                        </div>
                                        <!--end::Label-->
                                        <div class="d-flex flex-column mb-10 fv-row">
                                            <!--begin::Label-->
                                            <div class="fs-5 fw-bold required form-label mb-3">{{__('master.description')}}</div>
                                            <!--end::Label-->
                                            <textarea class="form-control form-control-solid rounded-3" placeholder="{{__('master.enter task description')}}" rows="4" name="description">{{$task->description}}</textarea>
                                        </div>
                                        <div class="d-flex flex-column mb-10 fv-row">
                                            <label class="form-label required">{{__('master.admin')}}</label>
                                            <select name="admin" aria-label="Select a Admin"  data-control="select2" data-placeholder="{{__('master.select admin')}}"  class="form-select form-select-solid fw-bold">
                                                <option value="">{{__('master.select admin')}}</option>
                                        ...
                                        <div class="d-flex flex-column mb-10 fv-row">
                                            <label class="form-label required">{{__('master.status')}}</label>
                                            <select name="status" aria-label="Select a Status"  data-control="select2" data-placeholder="{{__('master.select status')}}"  class="form-select form-select-solid fw-bold">
                            ...
                            <div class="mb-0">
                                <button type="submit" class="btn btn-primary" id="kt_subscriptions_create_button">
                                    ...
                                    <span class="indicator-label">{{__('master.edit task')}}</span>
                                    <!--end::Indicator label-->
