            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">{{__('master.edit vedio')}}</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <!--begin::Card title-->
                        <div class="card-title fs-3 fw-bold">{{__('master.edit vedio')}}</div>
                        <!--end::Card title-->
                    </div>
                    @if ($errors->any())
                    ...
                    <!--end::Card header-->
                    <!--begin::Form-->
                    <form class="form" action="{{route('admin.vedio.update',$video->id)}}" method="POST" enctype="multipart/form-data">
                        @method('patch')
                        @csrf
                        <!--begin::Card body-->
                        <div class="card-body p-9">
                            ...
                            <div class="row mb-5">
                                <!--begin::Col-->
                                <div class="col-xl-3">
                                    <div class="fs-6 fw-semibold mt-2 mb-3">{{__('master.vedio')}}</div>
                                </div>
                                <!--end::Col-->
                                <!--begin::Col-->
                                <div class="col-lg-8">
                            ...
                            <div class="row mb-8">
                                ...
                                <div class="col-xl-9 fv-row">
                                    <input type="text" class="form-control form-control-solid" name="title" value="{{$video->title}}" placeholder="{{__('master.title')}}" />
                                </div>
                            </div>
                            <!--end::Row-->
                            <!--begin::Row-->
                            <div class="row mb-8">
                                ...
                                <!--begin::Col-->
                                <div class="col-xl-9 fv-row">
                                    <input type="text" class="form-control form-control-solid" name="sub_title" value="{{$video->sub_title}}" placeholder="{{__('master.sub title')}}" />
                                </div>
                            </div>
                            <!--end::Row-->
                            <!--begin::Row-->
                            <div class="row mb-8">
                                ...
                                <!--begin::Col-->
                                <div class="col-xl-9 fv-row">
                                    <input type="text" class="form-control form-control-solid" name="link" value="{{$video->link}}" placeholder="{{__('master.link')}}" />
                                </div>
                            </div>
                            <!--end::Row-->
                            {{-- <div class="row mb-8">
                            ...
                            <div class="row mb-8">
                                ...
                                <div class="col-xl-9 fv-row">
                                    <select name="status" aria-label="Select a Status" data-control="select2" data-placeholder="{{__('master.select status')}}" class="form-select form-select-solid form-select-lg fw-semibold">
                                        ...
                                        <option value="active" @selected('active' == $video->status)>{{__('master.active')}}</option>
                                        <option value="draft" @selected('draft' == $video->status)>{{__('master.draft')}}</option>
                                    </select>
                                </div>
                                <!--end::Col-->
                            </div>
