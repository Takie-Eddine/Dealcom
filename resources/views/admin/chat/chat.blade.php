                                            ...
                                            <div class="d-flex flex-stack py-4">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="symbol symbol-45px symbol-circle">
                                                        <img class="symbol-label bg-light-danger text-danger fs-6 fw-bolder" src="{{$chat->participants[0]->user->profile->image_url}}" alt="">
                                                    ...
                                                    <div class="d-flex align-items-center mb-2">
                                                        ...
                                                        <div class="symbol symbol-35px symbol-circle">
                                                            @if ($message->tallker_id != Auth::user()->tallker->id)
                                                                <img alt="Pic" src="{{$message->user->user->profile->image_url}}" />
                                                            @else
