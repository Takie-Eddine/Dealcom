            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">{{__('master.edit brand')}}</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <!--begin::Card title-->
                        <div class="card-title fs-3 fw-bold">{{$brand->name}}</div>
                        <!--end::Card title-->
                    </div>
                    @if ($errors->any())
                    ...
                    <!--end::Card header-->
                    <!--begin::Form-->
                    <form class="form" action="{{route('admin.brand.update',$brand->id)}}" method="POST" enctype="multipart/form-data">
                        @method('patch')
                        @csrf
                        <!--begin::Card body-->
                        <div class="card-body p-9">
                            ...
                            <div class="row mb-8">
                                ...
                                <div class="col-xl-9 fv-row">
                                    <input type="text" class="form-control form-control-solid" name="name" value="{{$brand->name}}" placeholder="{{__('master.name')}}" />
                                </div>
                            </div>
                            <!--end::Row-->
                            <!--begin::Row-->
                            <div class="row mb-8">
                                ...
                                <!--begin::Col-->
                                <div class="col-xl-9 fv-row">
                                    <input type="text" class="form-control form-control-solid" name="code" value="{{$brand->code}}" placeholder="{{__('master.code')}}" />
                                </div>
                            </div>
                            <!--end::Row-->
                            <!--begin::Row-->
                            <div class="row mb-8">
                                ...
                                <!--begin::Col-->
                                <div class="col-xl-9 fv-row">
                                    <textarea name="description" class="form-control form-control-solid h-100px" placeholder="{{__('master.description')}}">{{$brand->description}}</textarea>
                                </div>
                                <!--begin::Col-->
                            </div>
                            <!--end::Row-->
                            <div class="row mb-8">
                                ...
                                <!--begin::Col-->
                                <div class="col-xl-9 fv-row">
                                    <input type="text" name="phone" class="form-control form-control-solid" placeholder="{{__('master.contact phone')}}" value="{{$brand->mobile_phone}}"/>
                                </div>
                                <!--begin::Col-->
                            </div>
                            ...
                            <div class="row mb-8">
                                ...
                                <!--begin::Col-->
                                <div class="col-xl-9 fv-row">
                                    <input type="text" name="office_phone" class="form-control form-control-solid" placeholder="{{__('master.contact phone')}}" value="{{$brand->office_phone}}" />
                                </div>
                                <!--begin::Col-->
                            </div>
                            ...
                            <div class="row mb-8">
                                ...
                                <!--begin::Col-->
                                <div class="col-xl-9 fv-row">
                                    <input type="email" name="email" class="form-control form-control-solid" placeholder="{{__('master.email')}}" value="{{$brand->email}}" />
                                </div>
                                <!--begin::Col-->
                            </div>
                                ...
                                <div class="col-xl-9 fv-row">
                                    <select name="country" aria-label="Select a Country" data-control="select2" data-placeholder="{{__('master.select country')}}" class="form-select form-select-solid form-select-lg fw-semibold">
                                        ...
                                        @foreach ($countries as $country => $value)
                                            <option value="{{$country}}"  @selected($country == $brand->country)>{{$value}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <!--end::Col-->
                            ...
                            <div class="row mb-8">
                                ...
                                <!--begin::Col-->
                                <div class="col-xl-9 fv-row">
                                    <input type="text" name="city" class="form-control form-control-lg form-control-solid" placeholder="{{__('master.city')}}" value="{{$brand->city}}" />
                                </div>
                                <!--end::Col-->
                            </div>
                            ...
                            <div class="row mb-8">
                                ...
                                <!--begin::Col-->
                                <div class="col-xl-9 fv-row">
                                    <input type="text" name="postal_code" class="form-control form-control-lg form-control-solid" placeholder="{{__('master.postal code')}}" value="{{$brand->postal_code}}" />
                                </div>
                                <!--end::Col-->
                            </div>
                            ...
                            <div class="row mb-8">
                                ...
                                <!--begin::Col-->
                                <div class="col-xl-9 fv-row">
                                    <input type="text" name="address" class="form-control form-control-lg form-control-solid" placeholder="{{__('master.address')}}" value="{{$brand->address}}" />
                                </div>
                                <!--end::Col-->
                            </div>
                        ...
                        <div class="card-footer d-flex justify-content-end py-6 px-9">
                            <a href="{{route('admin.brand')}}" id="kt_ecommerce_add_product_cancel" class="btn btn-light btn-active-light-primary me-2">Cancel</a>
