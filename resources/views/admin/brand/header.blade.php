    ...
    <div class="card-body pt-9 pb-0">
        ...
        <div class="d-flex flex-wrap flex-sm-nowrap mb-6">
            ...
            <div class="d-flex flex-center flex-shrink-0 bg-light rounded w-100px h-100px w-lg-150px h-lg-150px me-7 mb-4">
                <img class="mw-50px mw-lg-75px" src="{{$brand->image_url}}" alt="{{$brand->name}}" />
            </div>
            <!--end::Image-->
            <!--begin::Wrapper-->
                ...
                <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <div class="d-flex align-items-center mb-1">
                            <a href="#" class="text-gray-800 text-hover-primary fs-2 fw-bold me-3">{{$brand->name}}</a>
                        ...
                        <!--end::Status-->
                        <!--begin::Description-->
                        <div class="d-flex flex-wrap fw-semibold mb-4 fs-5 text-gray-400">{{$brand->description}}</div>
                        <!--end::Description-->
                    </div>
                    <!--end::Details-->
                    <!--begin::Actions-->
                    ...
                    <div class="d-flex flex-wrap">
                        ...
                        <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="fs-4 fw-bold">{{$brand->products->count()}}</div>
                            </div>
                            <!--end::Number-->
                            <!--begin::Label-->
        ...
        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
            <!--begin::Nav item-->
            <li class="nav-item">
                <a class="nav-link text-active-primary py-5 me-6 {{request()->routeIs('admin.brand.show') ? 'active' : ''}}" href="{{route('admin.brand.show',$brand->id)}}">{{__('master.overview')}}</a>
            </li>
            <!--end::Nav item-->
            <!--begin::Nav item-->
            <li class="nav-item">
                <a class="nav-link text-active-primary py-5 me-6 {{request()->routeIs('admin.brand.product') ? 'active' : ''}}" href="{{route('admin.brand.product',$brand->id)}}">{{__('master.products')}}</a>
            </li>
            <!--end::Nav item-->
        </ul>
        <!--end::Nav-->
