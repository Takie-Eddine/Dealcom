            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">{{__('master.edit slider')}}</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <!--begin::Card title-->
                        <div class="card-title fs-3 fw-bold">{{__('master.edit slider')}}</div>
                        <!--end::Card title-->
                    </div>
                    @if ($errors->any())
                    ...
                    <!--end::Card header-->
                    <!--begin::Form-->
                    <form class="form" action="{{route('admin.slider.update',$slider->id)}}" method="POST" enctype="multipart/form-data">
                        @method('patch')
                        @csrf
                        <!--begin::Card body-->
                        <div class="card-body p-9">
                            ...
                            <div class="row mb-8">
                                ...
                                <div class="col-xl-9 fv-row">
                                    <input type="text" class="form-control form-control-solid" name="name" value="{{$slider->name}}" placeholder="{{__('master.name')}}" />
                                </div>
                            </div>
                            <!--end::Row-->
                            <!--begin::Row-->
                            <div class="row mb-8">
                                ...
                                <!--begin::Col-->
                                <div class="col-xl-9 fv-row">
                                    <input type="text" class="form-control form-control-solid" name="link" value="{{$slider->link}}" placeholder="{{__('master.link')}}" />
                                </div>
                            </div>
                            <!--end::Row-->
                            <div class="row mb-8">
                                ...
                                <div class="col-xl-9 fv-row">
                                    <select name="page" aria-label="Select a Page" data-control="select2" data-placeholder="{{__('master.select page')}}" class="form-select form-select-solid form-select-lg fw-semibold">
                                        ...
                                        <option value="home" @selected('home' == $slider->page)>{{__('master.home')}}</option>
                                        <option value="product" @selected('product' == $slider->page)>{{__('master.product')}}</option>
                                        <option value="category" @selected('category' == $slider->page)>{{__('master.category')}}</option>
                                    </select>
                                </div>
                                <!--end::Col-->
                            </div>
                            <div class="row mb-8">
                                ...
                                <div class="col-xl-9 fv-row">
                                    <select name="position" aria-label="Select a Position" data-control="select2" data-placeholder="{{__('master.select position')}}" class="form-select form-select-solid form-select-lg fw-semibold">
                                        ...
                                        <option value="top" @selected('top' == $slider->position)>{{__('master.top')}}</option>
                                        <option value="center" @selected('center' == $slider->position)>{{__('master.center')}}</option>
                                        <option value="bottom" @selected('bottom' == $slider->position)>{{__('master.bottom')}}</option>
                                    </select>
                                </div>
                                <!--end::Col-->
                            </div>
                            <div class="row mb-8">
                                ...
                                <div class="col-xl-9 fv-row">
                                    <select name="locale" aria-label="Select a Locale" data-control="select2" data-placeholder="{{__('master.select locale')}}" class="form-select form-select-solid form-select-lg fw-semibold">
                                        ...
                                        <option value="en" @selected('en' == $slider->locale)>{{__('master.english')}}</option>
                                        <option value="ar" @selected('ar' == $slider->locale)>{{__('master.arabic')}}</option>
                                    </select>
                                </div>
                                <!--end::Col-->
                            </div>
                            <div class="row mb-8">
                                ...
                                <div class="col-xl-9 fv-row">
                                    <select name="status" aria-label="Select a Status" data-control="select2" data-placeholder="{{__('master.select status')}}" class="form-select form-select-solid form-select-lg fw-semibold">
                                        ...
                                        <option value="active" @selected('active' == $slider->status)>{{__('master.active')}}</option>
                                        <option value="draft" @selected('draft' == $slider->status)>{{__('master.draft')}}</option>
                                    </select>
                                </div>
                                <!--end::Col-->
                            </div>
