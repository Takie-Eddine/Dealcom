    ...
    <div class="card-body pt-9 pb-0">
        ...
        <div class="d-flex flex-wrap flex-sm-nowrap">
            ...
            <div class="me-7 mb-4">
                <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                    @if ($admin->profile->getFirstMediaUrl('avatars'))
                        <img src="{{$admin->profile->getFirstMediaUrl('avatars')}}" alt="image" />
                    @else
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <div class="d-flex flex-wrap fw-semibold fs-6 mb-4 pe-2">
                            ...
                            <i class="ki-duotone ki-geolocation fs-4 me-1">
                                <span class="path1"></span>
                                <span class="path2"></span>
                            </i>{{$admin->profile->country}}, {{$admin->profile->city}}</a>
        ...
        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
            ...
            <li class="nav-item mt-2">
                <a class="nav-link text-active-primary ms-0 me-10 py-5 {{request()->routeIs('admin.profile') ? 'active' : ''}}" href="{{route('admin.profile')}}">{{__('master.overview')}}</a>
            </li>
            <!--end::Nav item-->
            <!--begin::Nav item-->
            <li class="nav-item mt-2">
                <a class="nav-link text-active-primary ms-0 me-10 py-5 {{request()->routeIs('admin.profile.edit') ? 'active' : ''}}" href="{{route('admin.profile.edit',$admin->id)}}">{{__('master.settings')}}</a>
            </li>
            <!--end::Nav item-->
            <!--begin::Nav item-->
            {{-- <li class="nav-item mt-2">
