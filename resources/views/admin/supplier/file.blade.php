        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="d-flex flex-wrap flex-stack mb-6">
                    <!--begin::Title-->
                    <h3 class="fw-bold my-2">{{__('master.price list')}}
                        ...
                        <div class="d-flex align-items-center position-relative me-4">
                            ...
                            <form action="{{URL::current()}}" method="GET">
                                <div class="d-flex align-items-center position-relative my-1">
                                    ...
                                    <input type="text" name="keyword" value="{{ old('keyword', request()->input('keyword')) }}"  data-kt-customer-table-filter="search" class="form-control form-control-sm border-body bg-body w-150px ps-10" placeholder="{{__('master.search file')}}" />
                                </div>
                            </form>
                        </div>
                        <a href="{{route('admin.price-list.create')}}" class="btn btn-primary btn-sm">{{__('master.upload price list')}}</a>
                    </div>
                </div>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="card h-100">
                                <div class="card-body d-flex justify-content-center text-center flex-column p-8">
                                    <a href="{{route('admin.price-list.download',$file->id)}}" class="text-gray-800 text-hover-primary d-flex flex-column">
