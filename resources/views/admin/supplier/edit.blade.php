            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">{{__('master.edit supplier')}}</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <!--begin::Card title-->
                        <div class="card-title fs-3 fw-bold">{{$supplier->name}}</div>
                        <!--end::Card title-->
                    </div>
                    @if ($errors->any())
                    ...
                    <!--end::Card header-->
                    <!--begin::Form-->
                    <form class="form" action="{{route('admin.supplier.update',$supplier->id)}}" method="POST" enctype="multipart/form-data">
                        @method('patch')
                        @csrf
                        <!--begin::Card body-->
                        <div class="card-body p-9">
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url('{{asset("assets/media/svg/avatars/blank.svg")}}')">
                                        ...
                                        @if ($supplier->getFirstMediaUrl('suppliers'))
                                            <div class="image-input-wrapper w-125px h-125px bgi-position-center" style="background-size: 75%; background-image: url('{{$supplier->getFirstMediaUrl("suppliers")}}')"></div>
                                        @else
                            ...
                            <div class="row mb-8">
                                ...
                                <div class="col-xl-9 fv-row">
                                    <input type="text" class="form-control form-control-solid" name="name" value="{{$supplier->name}}" placeholder="{{__('master.name')}}" />
                                </div>
                            </div>
                            <!--end::Row-->
                            <!--begin::Row-->
                            <div class="row mb-8">
                                ...
                                <!--begin::Col-->
                                <div class="col-xl-9 fv-row">
                                    <input type="text" class="form-control form-control-solid" name="code" value="{{$supplier->code}}" placeholder="{{__('master.code')}}" />
                                </div>
                            </div>
                            <!--end::Row-->
                            <!--begin::Row-->
                            <div class="row mb-8">
                                ...
                                <!--begin::Col-->
                                <div class="col-xl-9 fv-row">
                                    <textarea name="description" class="form-control form-control-solid h-100px" placeholder="{{__('master.description')}}">{{$supplier->description}}</textarea>
                                </div>
                                <!--begin::Col-->
                            </div>
                            <!--end::Row-->
                            <div class="row mb-8">
                                ...
                                <!--begin::Col-->
                                <div class="col-xl-9 fv-row">
                                    <input type="text" name="phone" class="form-control form-control-solid" placeholder="{{__('master.contact phone')}}" value="{{$supplier->mobile_phone}}"/>
                                </div>
                                <!--begin::Col-->
                            </div>
                            ...
                            <div class="row mb-8">
                                ...
                                <!--begin::Col-->
                                <div class="col-xl-9 fv-row">
                                    <input type="text" name="office_phone" class="form-control form-control-solid" placeholder="{{__('master.contact phone')}}" value="{{$supplier->office_phone}}" />
                                </div>
                                <!--begin::Col-->
                            </div>
                            ...
                            <div class="row mb-8">
                                ...
                                <!--begin::Col-->
                                <div class="col-xl-9 fv-row">
                                    <input type="email" name="email" class="form-control form-control-solid" placeholder="{{__('master.email')}}" value="{{$supplier->email}}" />
                                </div>
                                <!--begin::Col-->
                            </div>
                                ...
                                <div class="col-xl-9 fv-row">
                                    <select name="country" aria-label="Select a Country" data-control="select2" data-placeholder="{{__('master.select country')}}" class="form-select form-select-solid form-select-lg fw-semibold">
                                        ...
                                        @foreach ($countries as $country => $value)
                                            <option value="{{$country}}"  @selected($country == $supplier->country)>{{$value}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <!--end::Col-->
                            ...
                            <div class="row mb-8">
                                ...
                                <!--begin::Col-->
                                <div class="col-xl-9 fv-row">
                                    <input type="text" name="city" class="form-control form-control-lg form-control-solid" placeholder="{{__('master.city')}}" value="{{$supplier->city}}" />
                                </div>
                                <!--end::Col-->
                            </div>
                            ...
                            <div class="row mb-8">
                                ...
                                <!--begin::Col-->
                                <div class="col-xl-9 fv-row">
                                    <input type="text" name="postal_code" class="form-control form-control-lg form-control-solid" placeholder="{{__('master.postal code')}}" value="{{$supplier->postal_code}}" />
                                </div>
                                <!--end::Col-->
                            </div>
                            ...
                            <div class="row mb-8">
                                ...
                                <!--begin::Col-->
                                <div class="col-xl-9 fv-row">
                                    <input type="text" name="address" class="form-control form-control-lg form-control-solid" placeholder="{{__('master.address')}}" value="{{$supplier->address}}" />
                                </div>
                                <!--end::Col-->
                            </div>
                            <div class="row mb-8">
                                ...
                                <div class="col-xl-9 fv-row">
                                    <select name="category[]" aria-label="Select a Category" multiple data-control="select2" data-placeholder="{{__('master.select category')}}" class="form-select form-select-solid form-select-lg fw-semibold">
                                        ...
                                        @foreach ($categories as $category)
                                            <option value="{{$category->id}}"  {{in_array($category->id,$supplier->categories->pluck('id')->toArray())? 'selected' : null }}>{{$category->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="card-footer d-flex justify-content-end py-6 px-9">
                            <a href="{{route('admin.supplier')}}" id="kt_ecommerce_add_product_cancel" class="btn btn-light btn-active-light-primary me-2">Cancel</a>
