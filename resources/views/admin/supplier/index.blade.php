            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">{{__('master.suppliers')}}</li>
                        <!--end::Item-->
                        ...
                        <div class="card-title">
                            ...
                            <form action="{{URL::current()}}" method="GET">
                                <div class="d-flex align-items-center position-relative my-1">
                                    ...
                                    <input type="text" name="keyword" value="{{ old('keyword', request()->input('keyword')) }}"  data-kt-customer-table-filter="search" class="form-control form-control-solid w-250px ps-12" placeholder="{{__('master.search supplier')}}" />
                                </div>
                            </form>
                            <!--end::Search-->
                        </div>
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                ...
                                <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                    <a  class="btn btn-primary"  href="{{route('admin.supplier.create')}}"><i class="ki-duotone ki-plus fs-2"></i>{{__('master.add supplier')}}</a>
                                </div>
                                <!--end::Add user-->
                            </div>
                            <!--end::Toolbar-->
                                    ...
                                    <tr>
                                        ...
                                        <td >
                                            @if ($supplier->status == 'active')
                                                <span class="badge py-3 px-4 fs-7 badge-light-success">{{$supplier->status}}</span>
                                            @endif
                                            @if ($supplier->status == 'inactive')
                                                <span class="badge py-3 px-4 fs-7 badge-light-warning">{{$supplier->status}}</span>
                                            @endif
                                            @if ($supplier->status == 'archived')
                                                <span class="badge py-3 px-4 fs-7 badge-light-danger">{{$supplier->status}}</span>
                                            @endif
                                        </td>
                                        <td class="text-end">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                                <div class="menu-item px-3">
                                                    <a href="{{route('admin.supplier.activate',$supplier->id)}}" class="menu-link px-3">
                                                        @if ($supplier->status == 'active')
                                                            {{__('master.unactive')}}
                                                        @else
                                                            {{__('master.active')}}
                                                ...
                                                @if ($supplier->status != 'archived')
                                                <div class="menu-item px-3">
                                                    <a href="{{route('admin.supplier.archived',$supplier->id)}}" class="menu-link px-3">
                                                            {{__('master.archived')}}
                                                    </a>
                                                </div>
                                                @endif
                                                <!--begin::Menu item-->
                                                <div class="menu-item px-3">
                                                    <a href="{{route('admin.supplier.edit',$supplier->id)}}" class="menu-link px-3">Edit</a>
                                                </div>
                                                <!--end::Menu item-->
                                                <!--begin::Menu item-->
                                                <div class="menu-item px-3">
                                                    <a href="{{route('admin.supplier.delete',$supplier->id)}}" class="menu-link px-3" data-kt-users-table-filter="delete_row">Delete</a>
                                                </div>
                                                <!--end::Menu item-->
                                            </div>
                                            <!--end::Menu-->
