            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <li class="breadcrumb-item text-muted">{{__('master.view role')}}</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                    ...
                    <div class="flex-column flex-lg-row-auto w-100 w-lg-200px w-xl-300px mb-10">
                        <div class="card card-flush">
                            ...
                            <div class="card-footer pt-0">
                                <a href="{{route('admin.roles.edit',$role->id)}}" class="btn btn-light btn-active-primary" >{{__('master.edit role')}}</a>
                            </div>
                        </div>
                    ...
                    <div class="flex-lg-row-fluid ms-lg-10">
                        ...
                        <div class="card card-flush mb-6 mb-xl-9">
                            ...
                            <div class="card-header pt-5">
                                <!--begin::Card title-->
                                <div class="card-title">
                                    <h2 class="d-flex align-items-center">{{__('master.admins assigned')}}
                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5 mb-0" >
                                    <thead>
                                        <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                            ...
                                            <th class="min-w-50px">{{__('master.id')}}</th>
                                            <th class="min-w-150px">{{__('master.admin')}}</th>
