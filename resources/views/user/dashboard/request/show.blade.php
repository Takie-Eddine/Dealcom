                        ...
                        @if ($modelrequest->admin_id)
                            <div id="kt_drawer_chat" class="bg-body" data-kt-drawer="true" data-kt-drawer-name="chat" data-kt-drawer-activate="true" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'300px', 'md': '500px'}" data-kt-drawer-direction="end" data-kt-drawer-toggle="#kt_drawer_chat_toggle" data-kt-drawer-close="#kt_drawer_chat_close">
                                ...
                                <div class="card w-100 border-0 rounded-0" id="kt_drawer_chat_messenger">
                                    ...
                                    <div class="card-body" id="kt_drawer_chat_messenger_body">
                                        ...
                                        <div class="scroll-y me-n5 pe-5" data-kt-element="messages" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_drawer_chat_messenger_header, #kt_drawer_chat_messenger_footer" data-kt-scroll-wrappers="#kt_drawer_chat_messenger_body" data-kt-scroll-offset="0px">
                                            @forelse ($messages as $message)
                                                <!--begin::Message(in)-->
                                                <div class="d-flex @if (Auth::user('web')->id == $message->user_id ) justify-content-end @else justify-content-start @endif mb-10">
                                                    <!--begin::Wrapper-->
                                                    <div class="d-flex flex-column @if (Auth::user('web')->id == $message->user_id ) align-items-end @else align-items-start @endif">
                                                        <!--begin::User-->
                                                        <div class="d-flex align-items-center mb-2">
                                                            <!--begin::Avatar-->
                                                            <div class="symbol symbol-35px symbol-circle">
                                                                @if (Auth::user('web')->id == $message->user_id)
                                                        ...
                                                        <!--end::User-->
                                                        <!--begin::Text-->
                                                        <div class="p-5 rounded @if (Auth::user('web')->id == $message->user_id) bg-light-primary  @else bg-light-info  @endif text-dark fw-semibold mw-lg-400px @if (Auth::user('web')->id == $message->user_id) text-end  @else text-start @endif " data-kt-element="message-text">
                                                            ...
                                                            @else
                                                                ...
                                                                @else
                                                                    <a href="{{route('request.download.message',$message->id)}}">{{$message->body}}</a>
                                                                @endif
                                                            @endif
                                    ...
                                    <!--end::Card body-->
                                    <!--begin::Card footer-->
                                    <form action="{{route('request.send')}}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @if ($chat->id)
                                            <input type="hidden" name="conversation_id" value="{{$chat->id}}">
                                        @else
                                            <input type="hidden" name="admin_id" value="{{$modelrequest->admin->id}}">
                                        @endif
