    ...
    <div class="card-body pt-9 pb-0">
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <div class="d-flex flex-wrap fw-semibold fs-6 mb-4 pe-2">
                            ...
                            <i class="ki-duotone ki-geolocation fs-4 me-1">
                                <span class="path1"></span>
                                <span class="path2"></span>
                            </i>{{$user->profile->country}}, {{$user->profile->address}}</a>
        ...
        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
            ...
            <li class="nav-item mt-2">
                <a class="nav-link text-active-primary ms-0 me-10 py-5 {{request()->routeIs('profile') ? 'active' : ''}}" href="{{route('profile')}}">{{__('master.overview')}}</a>
            </li>
            <!--end::Nav item-->
            <!--begin::Nav item-->
            <li class="nav-item mt-2">
                <a class="nav-link text-active-primary ms-0 me-10 py-5 {{request()->routeIs('profile.edit') ? 'active' : ''}}" href="{{route('profile.edit',$user->id)}}">{{__('master.settings')}}</a>
            </li>
            <!--end::Nav item-->
            <!--begin::Nav item-->
            {{-- <li class="nav-item mt-2">
