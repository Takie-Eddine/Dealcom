...
class ProductRequestNotification extends Notification
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        if ($this->request->product_id) {
            $message
                    ...
                    ->line('New request for the product ('.$this->request->product->name.') has been created')
    ...
    public function toDatabase(object $notifiable)
    {
        if ($this->request->product_id) {
            return[
                'title' => 'New Request',
                'body' => 'New request for the product ('.$this->request->product->name.') has been created',
                'image' => '',
